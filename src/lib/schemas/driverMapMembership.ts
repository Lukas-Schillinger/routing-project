...
export const driverMapMembershipWithRelationsSchema = driverMapMembershipSchema.extend({
	driver: z
		.object({
			id: z.string().uuid(),
			name: z.string(),
...
export type CreateDriverMapMembership = z.infer<typeof createDriverMapMembershipSchema>;
